  ...
  render: function () {
    return (
      <div className="chat-box">
        <h1 className="title">Chat Node React</h1>
  ...
  render: function () {
    return (
      <form className="chat-form" onSubmit={this.handleSubmit}>
        ...
        <input className="input body-input" type="text" placeholder="Escribe algo..." ref="body" />
...
var Message = React.createClass({
  ...
  render: function () {
    return (
      <li className="message"><p className="message-p"><strong className="message-user">{this.props.name}:</strong> <span className="message-content"> {this.props.children} </span><TimeAgo delay="500">{this.props.time}</TimeAgo></p></li>
    );
  },
